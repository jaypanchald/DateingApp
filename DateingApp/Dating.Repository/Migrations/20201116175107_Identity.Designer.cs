...
namespace Dating.Repository.Migrations
{
    ...
    [Migration("20201116175107_Identity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dating.Model.Entity.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dating.Model.Entity.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("Dating.Model.Entity.AppUserRole", b =>
                {
                    b.HasOne("Dating.Model.Entity.AppRole", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("Dating.Model.Entity.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("Dating.Model.Entity.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
